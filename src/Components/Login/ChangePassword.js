...
function ChangePassword() {
    ...
    const changepassword = async (data) => {
        let passwordCheckData = {
            ...
            "empPassword": data.curpassword,
            "newPassword": data.Cpassword,
        }
        postCommonData('/ESS-Java/api/emplyee/getUserDetails/', passwordCheckData)
            .then((res) => {
                        ...
                        >
                            <Box component="form" noValidate onSubmit={handleSubmit(onSubmitHandler)} sx={{ mt: 1 }}>
                                <TextField
                                    ...
                                    helperText={errors['curpassword'] ? errors['curpassword'].message : ''}
                                />

...
import Compoffrequest from './Compoffrequest'
 import Compoffreq from './Compoffreq'
        ...
        <Grid container component="main" className='dashboard'>
            <Box sx={{ display: 'flex', width: '100%' }}>
                ...
                <AppBar position="absolute" open={open}>
                    <Toolbar
                        sx={{
                            pr: '14px', backgroundColor: '#FFF', boxShadow: '6px 2px 10px #EEF1F7', '& .reports': {
                                color: '#B2BEB5'
                            }
                        }}>
                        <IconButton
                        ...
                        <Header headerContent={<Typography
                                component="h1"
                                variant="h6"
                                noWrap
                                sx={{ color: '#34383F' }}>
                                <span className='breadcrumb'>Request</span>/Comp Off Request
                            </Typography>} />
                    </Toolbar>
                </AppBar>

...
export default function Applyleave(props) {
    ...
    }, [data, errorreset, applybtnenable])
    ...
    return (
        <LocalizationProvider dateAdapter={AdapterDayjs}>
            <Grid>
                LEAVE APPLY
                <Button style={{ float: 'right' }} size='small' variant='outlined' onClick={leaveHistory}  >Leave History</Button>
            </Grid>
            ...
            <Button onClick={handleApplyLeave} disabled={applybtnenable} variant="contained" sx={{ textTransform: 'none', boxShadow: 'none' }}>
                Apply Leave
            </Button>
            <Button onClick={resetButtonHandler} disabled={resetbtnenable} variant="outlined" sx={{ textTransform: 'none', boxShadow: 'none', ml: 2 }}>
                Reset
            </Button>
